...
`clientLog` | String | `debug` | Chooses the level of logging to report from the client in the console if `livereload.clientConsole` is enabled. Available choices: `debug`, `info`, `warn`, `error`.
